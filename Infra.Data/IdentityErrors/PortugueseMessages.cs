...
namespace Infra.Data.IdentityErrors
{
    public class PortugueseMessages : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"UserName '{userName}' já está sendo utilizado." }; }
        ...
        public override IdentityError PasswordRequiresUniqueChars(int Int32) { return new IdentityError { Code = nameof(PasswordRequiresUniqueChars), Description = "As senhas devem usar pelo menos 3 caracteres diferentes." }; }
    }
}